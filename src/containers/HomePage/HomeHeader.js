                ...
                <div className="home-header-banner">
                    ...
                    <div className="content-down">
                        <div className="options">
                            ...
                            <div className="option-child">
                                <div className="icon-child"><i className="fas fa-heading"></i></div>
                            ...
                            <div class="option-child">
                                ...
                                <div className="text-child">Các gói phẫu thuật</div>
                            </div>
                            <div className="option-child">
                            ...
                            <div className="option-child">
                                <div className="icon-child"><i className="fas fa-user-clock"></i></div>
